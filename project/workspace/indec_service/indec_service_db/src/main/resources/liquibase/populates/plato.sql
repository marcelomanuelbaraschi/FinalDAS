INSERT INTO plato (idPlato, nombrePlato, imagenPlato, preparacion, idMenu)
VALUES
(1, 'Tortilla de Verduras', './../../../assets/img/menu/lunes/tortilla_verdura.jpg', 'Bata los huevos con pimienta, orégano o albahaca, y queso en un cuenco o tazón mediano.
                                                                                                         ...
                                                                                                         Refrigere lo que sobre dentro de las siguientes 2 horas.', 1 )
, (2, 'Panqueques de Pollo', './../../../assets/img/menu/martes/panqueques_de_pollo.jpg', '– Lavar la pechuga de pollo y poner en una olla con 4 tazas de agua.
                                                                                                              ...
                                                                                                              – Cocinar en el horno hasta calentar y dorar. Servir caliente 2 panqueques por persona.que tengas en casa', 2 )
,(3, 'Tortilla de Zanahorias', './../../../assets/img/menu/miercoles/tortilla_de_zanahoria.jpg', 'Calentar a fuego medio-alto 1 cucharada de aceite en una sartén mediana
                                                                                                                     ...
                                                                                                                     Si no quieren dar vuelta la tortilla, pueden usar el broiler del horno para dorarla arriba,     quedan igual de bien. Yo hago eso en mi casa.', 3)
,(4, 'Hummus', './../../../assets/img/menu/jueves/hummus.jpg', 'Podemos usar garbanzos de bote o cocer los garbanzos. Si optamos por esta opción,
                                                                                   ...
                                                                                   y pimentón dulce para decorarlo. Por último, elegimos el acompañamiento deseado.', 4)
,(5, 'Tallarines alfredo', './../../../assets/img/menu/viernes/tallarines.jpg', 'Cocina los tallarines como los sueles preparar.
                                                                                                    ...
                                                                                                    Después condimenta esta mezcla con sal al gusto y añade el jamón cortado en cuadrados.  Posteriormente agrega la salsa sobre los tallarines y finaliza decorando con perejil si deseas. ¡Provecho!', 5 )
,(6, 'Bistec a la plancha', './../../../assets/img/menu/sabado/bistec_a_la_plancha.jpg', 'Lo primero antes de preparar, debemos sazonar la carne con todos los aliños y
                                                                                                             ...
                                                                                                             por eso no debemos subir mucho la llama. Se pueden acompañar con arroz blanco, papas, puré, y una fresca ensalada verde de lechuga, cebolla y tomate.', 6)
,(7, 'Croquetas de Atun', './../../../assets/img/menu/domingo/croquetas_de_atun.jpg', 'Retirar el atún de la lata y escurrir su líquido.
