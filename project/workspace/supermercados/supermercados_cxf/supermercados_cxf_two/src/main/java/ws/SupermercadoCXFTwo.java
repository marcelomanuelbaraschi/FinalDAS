...
@WebService(targetNamespace = "http://ws.das.edu.ubp.ar/", portName = "SupermercadoCXFTwoPort", serviceName = "SupermercadoCXFTwoService")
public class SupermercadoCXFTwo {
    protected static final Logger log = LoggerFactory.getLogger(SupermercadoCXFTwo.class);
